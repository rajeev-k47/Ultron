...
@Composable
fun BottomAddSheet(onSubmit:(String,String)->Unit, onSwitch:(Boolean)->Unit){
    val sheetState = rememberModalBottomSheetState()
    var name by rememberSaveable { mutableStateOf("") }
    var trailingUrl by rememberSaveable { mutableStateOf("") }
    ModalBottomSheet(
        ...
        TextField(
            ...
            placeholder = { Text("Enter name of function") },
            modifier = Modifier
                .fillMaxWidth()
        ...
        TextField(
            value = trailingUrl,
            onValueChange = {trailingUrl = it},
            placeholder = { Text("Enter trailing url") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(horizontal = 10.dp)
                .border(2.dp, Color.Gray, RoundedCornerShape(16.dp)), // Add border here
